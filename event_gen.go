...
func (_class EventClass) Inject__mock(sessionID SessionRef, class string, ref string) (_retval string, _err error) {
...
func (_class EventClass) Inject(sessionID SessionRef, class string, ref string) (_retval string, _err error) {
	if (IsMock) {
		return _class.Inject__mock(sessionID, class, ref)
	}	
...
func (_class EventClass) GetCurrentID__mock(sessionID SessionRef) (_retval int, _err error) {
...
func (_class EventClass) GetCurrentID(sessionID SessionRef) (_retval int, _err error) {
	if (IsMock) {
		return _class.GetCurrentID__mock(sessionID)
	}	
...
func (_class EventClass) From__mock(sessionID SessionRef, classes []string, token string, timeout float64) (_retval []EventRecord, _err error) {
...
func (_class EventClass) From(sessionID SessionRef, classes []string, token string, timeout float64) (_retval []EventRecord, _err error) {
	if (IsMock) {
		return _class.From__mock(sessionID, classes, token, timeout)
	}	
	_method := "event.from"
	_sessionIDArg, _err := convertSessionRefToXen(fmt.Sprintf("%s(%s)", _method, "session_id"), sessionID)
	if _err != nil {
...
func (_class EventClass) Next__mock(sessionID SessionRef) (_retval []EventRecord, _err error) {
...
func (_class EventClass) Next(sessionID SessionRef) (_retval []EventRecord, _err error) {
	if (IsMock) {
		return _class.Next__mock(sessionID)
	}	
	_method := "event.next"
	_sessionIDArg, _err := convertSessionRefToXen(fmt.Sprintf("%s(%s)", _method, "session_id"), sessionID)
	if _err != nil {
...
func (_class EventClass) Unregister__mock(sessionID SessionRef, classes []string) (_err error) {
...
func (_class EventClass) Unregister(sessionID SessionRef, classes []string) (_err error) {
	if (IsMock) {
		return _class.Unregister__mock(sessionID, classes)
	}	
...
func (_class EventClass) Register__mock(sessionID SessionRef, classes []string) (_err error) {
...
func (_class EventClass) Register(sessionID SessionRef, classes []string) (_err error) {
	if (IsMock) {
		return _class.Register__mock(sessionID, classes)
	}	
